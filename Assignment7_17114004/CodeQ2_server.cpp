...
{ 
    ...
    /* Redundancy bits */
   /// Counter for number of redundancy bit
    int nrb=0;      
    /// Array to hold redundancy bits
    int rb[8];      
    ...
    for(i1=1;i1<=l;i1++)
    {
        ...
        if(df[i1]==-1)
        {
            ...
            ///Display Parity. Add redundancy bit in data frame. odd parity -> 1 :: even parity -> 0
    ...
    cout << "Server : Sending the code word\n";
