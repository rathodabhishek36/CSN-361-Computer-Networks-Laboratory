...
void correct(string cword) {
    ...
    cout << "The error location is " << ep << endl;
    cw[ep] = !cw[ep];
    string a="";
    ...
    cout << "The correct data word is: " << a <<endl ;
    return ;
}
int main(int argc, char const *arguments[]) {
    ...
    cout << "The message from the server is " << buffer << endl; ///7.print the buffer value on the screen
